const maps = Array.from(document.querySelectorAll('.iran-map__svg g:not(.iran-map__border):not(.iran-map__sea):not(.iran-map__lake) path'))
...
maps.forEach(map => {
    ...
    map.addEventListener('click', e => {
        // Simply add click event handler for a specific location
    })
})
